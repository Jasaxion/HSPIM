...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "general_logs_dir": "Logs directory",
        ...
        "general_debug_mode": "Enable debug logging",
