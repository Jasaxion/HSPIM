...
def build_app() -> gr.Blocks:
    ...
    with gr.Blocks(theme=theme, title=translate("app_title", default_language)) as demo:
        ...
        with gr.Tabs() as tabs:
            ...
            with gr.Tab(translate("config_tab", default_language)) as config_tab:
                ...
                def on_reload(language_value):
                    ...
                    return (
                        gr.Dropdown.update(value=latest["model_provider"]),
                        gr.Textbox.update(value=latest["model_name"]),
                        gr.Textbox.update(value=latest["model_api_key"]),
                        gr.Textbox.update(value=latest["model_base_url"]),
                        gr.Slider.update(value=latest["model_temperature"]),
                        gr.Number.update(value=latest["model_max_tokens"]),
                        gr.Number.update(value=latest["model_request_timeout"]),
                        gr.Textbox.update(value=latest["model_extra"]),
                        gr.Textbox.update(value=latest["general_data_dir"]),
                        gr.Textbox.update(value=latest["general_review_dir"]),
                        gr.Textbox.update(value=latest["general_output_dir"]),
                        gr.Checkbox.update(value=latest["general_overwrite"]),
                        gr.Number.update(value=latest["general_max_workers"]),
                        gr.Number.update(value=latest["general_retry_limit"]),
                        gr.Checkbox.update(value=latest["general_enable_logging"]),
                        gr.Textbox.update(value=latest["mineru_api_key"]),
                        gr.Textbox.update(value=latest["mineru_base_url"]),
                        gr.Checkbox.update(value=latest["mineru_use_ocr"]),
                        gr.Checkbox.update(value=latest["mineru_enable_formula"]),
                        gr.Checkbox.update(value=latest["mineru_enable_table"]),
                        gr.Textbox.update(value=latest["mineru_language"]),
                        gr.Dropdown.update(value=latest["ui_default_language"]),
                        gr.Dropdown.update(value=latest["ui_theme"]),
                        gr.Checkbox.update(value=latest["ui_enhanced_parsing_default"]),
                        gr.Markdown.update(value=translate("config_reload_success", lang_code)),
                    )
        ...
        def on_language_change(selection: str):
            ...
            return (
                lang_code,
                gr.Markdown.update(value=f"# {translate('app_title', lang_code)}"),
                gr.Dropdown.update(
                    choices=choices,
                    value=_language_label(lang_code, lang_code),
                    label=translate("language_label", lang_code),
                ),
                gr.Tab.update(label=translate("analysis_tab", lang_code)),
                gr.Tab.update(label=translate("config_tab", lang_code)),
                gr.File.update(label=translate("upload_label", lang_code)),
                gr.Checkbox.update(label=translate("enhanced_parsing", lang_code)),
                gr.Button.update(value=translate("analyze_button", lang_code)),
                gr.Markdown.update(label=translate("analysis_summary", lang_code)),
                gr.HTML.update(label=translate("sections_title", lang_code)),
                gr.JSON.update(label=translate("raw_output_title", lang_code)),
                gr.Markdown.update(value=translate("config_description", lang_code)),
                gr.Accordion.update(label=translate("model_section_title", lang_code)),
                gr.Dropdown.update(label=translate("model_provider", lang_code)),
                gr.Textbox.update(label=translate("model_name", lang_code)),
                gr.Textbox.update(label=translate("model_api_key", lang_code)),
                gr.Textbox.update(label=translate("model_base_url", lang_code)),
                gr.Slider.update(label=translate("model_temperature", lang_code)),
                gr.Number.update(label=translate("model_max_tokens", lang_code)),
                gr.Number.update(label=translate("model_request_timeout", lang_code)),
                gr.Textbox.update(label=translate("model_extra", lang_code)),
                gr.Accordion.update(label=translate("general_section_title", lang_code)),
                gr.Textbox.update(label=translate("general_data_dir", lang_code)),
                gr.Textbox.update(label=translate("general_review_dir", lang_code)),
                gr.Textbox.update(label=translate("general_output_dir", lang_code)),
                gr.Checkbox.update(label=translate("general_overwrite", lang_code)),
                gr.Number.update(label=translate("general_max_workers", lang_code)),
                gr.Number.update(label=translate("general_retry_limit", lang_code)),
                gr.Checkbox.update(label=translate("general_enable_logging", lang_code)),
                gr.Accordion.update(label=translate("mineru_section_title", lang_code)),
                gr.Textbox.update(label=translate("mineru_api_key", lang_code)),
                gr.Textbox.update(label=translate("mineru_base_url", lang_code)),
                gr.Checkbox.update(label=translate("mineru_use_ocr", lang_code)),
                gr.Checkbox.update(label=translate("mineru_enable_formula", lang_code)),
                gr.Checkbox.update(label=translate("mineru_enable_table", lang_code)),
                gr.Textbox.update(label=translate("mineru_language", lang_code)),
                gr.Accordion.update(label=translate("ui_section_title", lang_code)),
                gr.Dropdown.update(label=translate("ui_default_language", lang_code)),
                gr.Dropdown.update(label=translate("ui_theme", lang_code)),
                gr.Checkbox.update(label=translate("ui_enhanced_parsing_default", lang_code)),
                gr.Button.update(value=translate("config_save", lang_code)),
                gr.Button.update(value=translate("config_reload", lang_code)),
